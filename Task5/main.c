...
//  razrjesavacKonflikta1 = xSemaphoreCreateBinary();
//  razrjesavacKonflikta1 = xSemaphoreCreateCounting(2, 2);
  xSemaphoreGive(razrjesavacKonflikta1);
  xSemaphoreGive(razrjesavacKonflikta2);
  xTaskCreate(zadatak1, "zadatak1", 128, NULL, 3, &zadatak1Handle);
  xTaskCreate(zadatak2, "zadatak2", 128, NULL, 2, &zadatak2Handle);
  xTaskCreate(zadatak3, "zadatak3", 128, NULL, 1, &zadatak3Handle);
