...
//  razrjesavacKonflikta = xSemaphoreCreateBinary();
//  razrjesavacKonflikta = xSemaphoreCreateCounting(2, 2);
  xSemaphoreGive(razrjesavacKonflikta1);
  razrjesavacKonflikta2 = xSemaphoreCreateMutex();
  xSemaphoreGive(razrjesavacKonflikta2);
  xTaskCreate(zadatak1, "zadatak1", 128, NULL, 1, &zadatak1Handle);
  xTaskCreate(zadatak2, "zadatak2", 128, NULL, 1, &zadatak2Handle);
